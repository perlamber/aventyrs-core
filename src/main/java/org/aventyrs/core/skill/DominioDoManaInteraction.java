 ...
 * entity or casting-resolution engine exists). If the character has a
 ...
 * {@code DominioDoManaCompetencyAbility.MAGIA_SELVAGEM}), that Attribute is used in place of
 * Domínio do Mana's normal Foco for {@link CharacterSkillService#getValueForRoll}.
 */
