...
/**
 * Requests a Persuasão Perícia test. Which of Persuasão's specializations ({@link
 * PersuasaoSpecialization}) the roll is for doesn't change {@code skillRollBonus}/{@code
 ...
 * thresholds. The rules text also has an opposed Atenção roll resist Persuasão; that resolution
