 ...
 * registers an ongoing {@link Withering} (see {@link CharacterSheet#applyEffect}) and
 ...
 * CharacterSheet#tickTemporaryEffects()}, same as {@link Sangramento}/{@link ManaPurge}'s
 * own ongoing halves.
 *
 * <p>Its damage is curse damage (bypasses Shield points, see {@link
 * CharacterSheet#applyCurseDamage}) — Definhar's own rules text names it "Dano Físico
