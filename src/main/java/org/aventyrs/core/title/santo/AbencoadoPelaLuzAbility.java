 ...
 * own gated abilities) are added.
 */
@Getter
@AllArgsConstructor
public enum AbencoadoPelaLuzAbility implements AventyrTitleAbility {

    // Requer Especialização 'Abençoado pela Luz'. Fully TODO'd: "obrigar" enemies to target
    ...
    ORGULHO_ELDURIANO(
            ...
            false, 1, 2, false, Optional.empty()),

    // Requer Especialização 'Abençoado pela Luz'. Two separate halves, only one still TODO'd.
    ...
    // Requer Especialização 'Abençoado pela Luz'. Fully TODO'd: the RA half is conditioned on
    ...
    PELE_ROCHOSA_DE_EPONA(
            ...
            false, 2, 2, false, Optional.empty()),

    // Requer 2 Habilidades de 'Abençoado pela Luz' (unenforced). Fully TODO'd, two separate
