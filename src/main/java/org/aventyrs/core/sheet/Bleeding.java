 ...
 * own immediate PV loss, via {@link CombatantSheet#applyEffect(TemporaryEffect)}. Counts down
 ...
 * CombatantSheet#tickTemporaryEffects()} — called once per Rodada by {@link
 ...
 * alone; only {@link CombatantSheet#heal(int)} interrupting it (per Sangramento's own
