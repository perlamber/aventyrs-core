 ...
 * immediate PM loss, via {@link CharacterSheet#applyEffect(TemporaryEffect)}. Counts down
 ...
 * by {@link CharacterSheet#tickTemporaryEffects()} — called once per Rodada by {@link
 ...
 * alone; only {@link CharacterSheet#recoverMagicPoints(int)} interrupting it (per
